...
namespace GenericListTestProject
{
    ...
    {
        private static readonly int VALUE_A = 1;
        private static readonly int VALUE_B = 2;
        private static readonly int VALUE_C = 3;
        private static readonly int VALUE_D = 4;
        private static readonly int VALUE_E = 5;
        private static readonly int VALUE_F = 6;
        private IGenericList<int> _list;

        [TestMethod]
        public void TestInsert()
        {
            this._list = new GenericList<int>();
        ...
        //    Assert.IsFalse(this._list.Delete());
        //    Assert.IsTrue(this._list.IsEmpty());
        //    Assert.AreEqual(0, this._list.Size());
